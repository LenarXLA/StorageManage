...
namespace StorageManage.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class StorageManageModule : ModuleBase {
    public StorageManageModule() {
        // 
        // StorageManageModule
        // 
        ...
        // Добавляем ссылки на бизнес модели
        AdditionalExportedTypes.AddRange(
            new Type[] { typeof(Warehouse), typeof(Picket), 
                typeof(Square), typeof(Cargo)});
